# Generated by Powerlevel10k configuration wizard on 2022-10-31 at 14:40 MDT.
...
() {
  ...
  function my_git_formatter() {
    ...
    local   modified='%F{#f2bba3}'
    local  untracked='%F{#f2bba3}'
  ...
  typeset -g POWERLEVEL9K_PYENV_BACKGROUND=13

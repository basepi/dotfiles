...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_konsole") && g:CSApprox_konsole) || &term =~? "^konsole"
    ...
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=151 gui=NONE guibg=bg guifg=#90dcb0
    CSAHi NonText term=bold cterm=bold ctermbg=59 ctermfg=59 gui=bold guibg=#1a202a guifg=#382920
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=188 gui=NONE guibg=bg guifg=#bbd0df
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=203 ctermfg=231 gui=NONE guibg=#ff4545 guifg=#ffffff
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=187 ctermfg=59 gui=reverse guibg=#3a4520 guifg=#babeaa
    CSAHi Search term=reverse cterm=NONE ctermbg=144 ctermfg=59 gui=NONE guibg=#808373 guifg=#3a4520
    ...
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=146 gui=NONE guibg=#000000 guifg=#8095d5
    ...
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=67 ctermfg=146 gui=NONE guibg=#3a6595 guifg=#9aadd5
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=74 ctermfg=153 gui=NONE guibg=#4a85ba guifg=#b0d0f0
    ...
    CSAHi TabLine term=underline cterm=NONE ctermbg=102 ctermfg=103 gui=NONE guibg=#4d4d5f guifg=#5b7098
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=102 ctermfg=110 gui=NONE guibg=#515a71 guifg=#50aae5
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=59 ctermfg=248 gui=NONE guibg=#2d2d3f guifg=#aaaaaa
    ...
    CSAHi ColorColumn term=reverse cterm=NONE ctermbg=60 ctermfg=fg gui=NONE guibg=#394658 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=188 ctermfg=23 gui=NONE guibg=#cad5c0 guifg=#05293d
    CSAHi lCursor term=NONE cterm=NONE ctermbg=145 ctermfg=59 gui=NONE guibg=#8b9aaa guifg=#1a202a
    ...
    CSAHi Comment term=bold cterm=NONE ctermbg=59 ctermfg=72 gui=NONE guibg=#1a202a guifg=#369960
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=110 gui=NONE guibg=bg guifg=#70a0de
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=109 gui=NONE guibg=bg guifg=#50a0b0
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=145 gui=NONE guibg=bg guifg=#a090b0
    ...
    CSAHi Statement term=bold cterm=NONE ctermbg=bg ctermfg=188 gui=NONE guibg=bg guifg=#cac0c0
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=181 gui=NONE guibg=bg guifg=#c0a0b0
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=116 gui=NONE guibg=bg guifg=#6ac0ba
    ...
    CSAHi Error term=reverse cterm=NONE ctermbg=210 ctermfg=231 gui=NONE guibg=#f06070 guifg=#ffffff
    CSAHi Todo term=NONE cterm=NONE ctermbg=226 ctermfg=202 gui=NONE guibg=#eeee00 guifg=#ff4500
    CSAHi Number term=NONE cterm=NONE ctermbg=bg ctermfg=74 gui=NONE guibg=bg guifg=#1da5da
    ...
    CSAHi Function term=NONE cterm=NONE ctermbg=59 ctermfg=145 gui=NONE guibg=#1a202a guifg=#a090a0
    CSAHi Conditional term=NONE cterm=NONE ctermbg=59 ctermfg=182 gui=NONE guibg=#1a202a guifg=#c08ac0
    CSAHi Repeat term=NONE cterm=NONE ctermbg=59 ctermfg=176 gui=NONE guibg=#1a202a guifg=#c07ac0
    CSAHi vimHiCtermColor term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Keyword term=NONE cterm=bold ctermbg=59 ctermfg=250 gui=bold guibg=#1a202a guifg=#bebebe
    CSAHi Exception term=NONE cterm=NONE ctermbg=59 ctermfg=145 gui=NONE guibg=#1a202a guifg=#aaa4a0
    ...
    CSAHi ExtraWhitespace term=NONE cterm=NONE ctermbg=28 ctermfg=fg gui=NONE guibg=#006400 guifg=fg
    ...
    CSAHi Operator term=NONE cterm=NONE ctermbg=59 ctermfg=143 gui=NONE guibg=#1a202a guifg=#aa9a45
    ...
    CSAHi TabWhitespace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=59 ctermfg=60 gui=NONE guibg=#22253d guifg=#223355
    ...
    CSAHi Underlined term=underline cterm=NONE ctermbg=bg ctermfg=103 gui=NONE guibg=bg guifg=#5b759a
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=60 ctermfg=250 gui=NONE guibg=#394658 guifg=#bebebe
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=60 ctermfg=250 gui=NONE guibg=#394658 guifg=#bebebe
    CSAHi vimMenuRhs term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=108 gui=NONE guibg=bg guifg=#6d806a
    CSAHi Visual term=reverse cterm=NONE ctermbg=81 ctermfg=16 gui=NONE guibg=#43d5ff guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=147 ctermfg=59 gui=bold,underline guibg=#a3a5ff guifg=#201a30
    ...
    CSAHi Folded term=NONE cterm=NONE ctermbg=59 ctermfg=188 gui=NONE guibg=#222038 guifg=#bbddcc
    ...
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=16 ctermfg=187 gui=NONE guibg=#000000 guifg=#dbcaa5
...
elseif has("gui_running") || (&t_Co == 256 && (&term ==# "xterm" || &term =~# "^screen") && exists("g:CSApprox_eterm") && g:CSApprox_eterm) || &term =~? "^eterm"
    ...
    CSAHi perlVarBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlVarBlock2 term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=158 gui=NONE guibg=bg guifg=#90dcb0
    CSAHi NonText term=bold cterm=bold ctermbg=59 ctermfg=59 gui=bold guibg=#1a202a guifg=#382920
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=195 gui=NONE guibg=bg guifg=#bbd0df
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=210 ctermfg=255 gui=NONE guibg=#ff4545 guifg=#ffffff
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=188 ctermfg=65 gui=reverse guibg=#3a4520 guifg=#babeaa
    CSAHi Search term=reverse cterm=NONE ctermbg=145 ctermfg=65 gui=NONE guibg=#808373 guifg=#3a4520
    CSAHi MoreMsg term=bold cterm=bold ctermbg=bg ctermfg=72 gui=bold guibg=bg guifg=#2e8b57
    CSAHi ModeMsg term=bold cterm=bold ctermbg=bg ctermfg=45 gui=bold guibg=bg guifg=#00aacc
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=153 gui=NONE guibg=#000000 guifg=#8095d5
    CSAHi vimClusterName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SpellLocal term=underline cterm=undercurl ctermbg=bg ctermfg=fg gui=undercurl guibg=bg guifg=fg guisp=#00ffff
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=68 ctermfg=189 gui=NONE guibg=#3a6595 guifg=#9aadd5
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=110 ctermfg=195 gui=NONE guibg=#4a85ba guifg=#b0d0f0
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=#bebebe guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=152 ctermfg=59 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=NONE ctermbg=102 ctermfg=110 gui=NONE guibg=#4d4d5f guifg=#5b7098
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=103 ctermfg=117 gui=NONE guibg=#515a71 guifg=#50aae5
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=59 ctermfg=188 gui=NONE guibg=#2d2d3f guifg=#aaaaaa
    ...
    CSAHi vimSynMatchRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi VimSynMtchCchar term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi ColorColumn term=reverse cterm=NONE ctermbg=66 ctermfg=fg gui=NONE guibg=#394658 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=231 ctermfg=23 gui=NONE guibg=#cad5c0 guifg=#05293d
    CSAHi lCursor term=NONE cterm=NONE ctermbg=152 ctermfg=59 gui=NONE guibg=#8b9aaa guifg=#1a202a
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=37 ctermfg=fg gui=NONE guibg=#008b8b guifg=fg
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=59 ctermfg=78 gui=NONE guibg=#1a202a guifg=#369960
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=153 gui=NONE guibg=bg guifg=#70a0de
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=116 gui=NONE guibg=bg guifg=#50a0b0
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=182 gui=NONE guibg=bg guifg=#a090b0
    CSAHi rubyMethodBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAugroup term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAugroupError term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimSyncLines term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncMatch term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=NONE ctermbg=bg ctermfg=231 gui=NONE guibg=bg guifg=#cac0c0
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=224 gui=NONE guibg=bg guifg=#c0a0b0
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=122 gui=NONE guibg=bg guifg=#6ac0ba
    CSAHi vimSyncRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=241 gui=NONE guibg=bg guifg=#666666
    CSAHi Error term=reverse cterm=NONE ctermbg=211 ctermfg=255 gui=NONE guibg=#f06070 guifg=#ffffff
    CSAHi Todo term=NONE cterm=NONE ctermbg=226 ctermfg=208 gui=NONE guibg=#eeee00 guifg=#ff4500
    CSAHi Number term=NONE cterm=NONE ctermbg=bg ctermfg=81 gui=NONE guibg=bg guifg=#1da5da
    CSAHi vimMenuMap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyDoBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyCurlyBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyArrayDelimiter term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimHiKeyList term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiBang term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Function term=NONE cterm=NONE ctermbg=59 ctermfg=182 gui=NONE guibg=#1a202a guifg=#a090a0
    CSAHi Conditional term=NONE cterm=NONE ctermbg=59 ctermfg=219 gui=NONE guibg=#1a202a guifg=#c08ac0
    CSAHi Repeat term=NONE cterm=NONE ctermbg=59 ctermfg=219 gui=NONE guibg=#1a202a guifg=#c07ac0
    CSAHi vimHiCtermColor term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Keyword term=NONE cterm=bold ctermbg=59 ctermfg=250 gui=bold guibg=#1a202a guifg=#bebebe
    CSAHi Exception term=NONE cterm=NONE ctermbg=59 ctermfg=188 gui=NONE guibg=#1a202a guifg=#aaa4a0
    CSAHi rubyOptionalDoLine term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyRepeatExpression term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimEscapeBrace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSetEqual term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimPatRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlFormat term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Operator term=NONE cterm=NONE ctermbg=59 ctermfg=186 gui=NONE guibg=#1a202a guifg=#aa9a45
    CSAHi vimHiTermcap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimCommentTitleLeader term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimGlobal term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi TabWhitespace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimSyncLinebreak term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncLinecont term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Underlined term=underline cterm=NONE ctermbg=bg ctermfg=110 gui=NONE guibg=bg guifg=#5b759a
    CSAHi perlGenericBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimExtCmd term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimFilter term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSet term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=66 ctermfg=250 gui=NONE guibg=#394658 guifg=#bebebe
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=66 ctermfg=250 gui=NONE guibg=#394658 guifg=#bebebe
    CSAHi vimMenuRhs term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=144 gui=NONE guibg=bg guifg=#6d806a
    CSAHi Visual term=reverse cterm=NONE ctermbg=123 ctermfg=16 gui=NONE guibg=#43d5ff guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=189 ctermfg=59 gui=bold,underline guibg=#a3a5ff guifg=#201a30
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=bg ctermfg=217 gui=NONE guibg=bg guifg=#fa8072
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=#ffff00 guifg=#000000
    CSAHi Folded term=NONE cterm=NONE ctermbg=59 ctermfg=195 gui=NONE guibg=#222038 guifg=#bbddcc
    CSAHi rubyRegexpParens term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyRegexpBrackets term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAuSyntax term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimUserCmd term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi perlVarMember term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimNormCmds term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=16 ctermfg=230 gui=NONE guibg=#000000 guifg=#dbcaa5
    CSAHi DiffAdd term=bold cterm=NONE ctermbg=19 ctermfg=fg gui=NONE guibg=#00008b guifg=fg
    CSAHi DiffChange term=bold cterm=NONE ctermbg=127 ctermfg=fg gui=NONE guibg=#8b008b guifg=fg
    CSAHi DiffDelete term=bold cterm=bold ctermbg=37 ctermfg=21 gui=bold guibg=#008b8b guifg=#0000ff
    CSAHi DiffText term=reverse cterm=bold ctermbg=196 ctermfg=fg gui=bold guibg=#ff0000 guifg=fg
...
elseif has("gui_running") || &t_Co == 256
    ...
    CSAHi perlVarBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlVarBlock2 term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=115 gui=NONE guibg=bg guifg=#90dcb0
    CSAHi NonText term=bold cterm=bold ctermbg=16 ctermfg=52 gui=bold guibg=#1a202a guifg=#382920
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=152 gui=NONE guibg=bg guifg=#bbd0df
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=203 ctermfg=231 gui=NONE guibg=#ff4545 guifg=#ffffff
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=145 ctermfg=58 gui=reverse guibg=#3a4520 guifg=#babeaa
    CSAHi Search term=reverse cterm=NONE ctermbg=101 ctermfg=58 gui=NONE guibg=#808373 guifg=#3a4520
    CSAHi MoreMsg term=bold cterm=bold ctermbg=bg ctermfg=29 gui=bold guibg=bg guifg=#2e8b57
    CSAHi ModeMsg term=bold cterm=bold ctermbg=bg ctermfg=38 gui=bold guibg=bg guifg=#00aacc
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=104 gui=NONE guibg=#000000 guifg=#8095d5
    CSAHi vimClusterName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SpellLocal term=underline cterm=undercurl ctermbg=bg ctermfg=fg gui=undercurl guibg=bg guifg=fg guisp=#00ffff
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=60 ctermfg=110 gui=NONE guibg=#3a6595 guifg=#9aadd5
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=67 ctermfg=153 gui=NONE guibg=#4a85ba guifg=#b0d0f0
    CSAHi PmenuSbar term=NONE cterm=NONE ctermbg=250 ctermfg=fg gui=NONE guibg=#bebebe guifg=fg
    CSAHi PmenuThumb term=NONE cterm=NONE ctermbg=103 ctermfg=16 gui=reverse guibg=bg guifg=fg
    CSAHi TabLine term=underline cterm=NONE ctermbg=59 ctermfg=60 gui=NONE guibg=#4d4d5f guifg=#5b7098
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=59 ctermfg=74 gui=NONE guibg=#515a71 guifg=#50aae5
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=17 ctermfg=248 gui=NONE guibg=#2d2d3f guifg=#aaaaaa
    CSAHi CursorColumn term=reverse cterm=NONE ctermbg=241 ctermfg=fg gui=NONE guibg=#666666 guifg=fg
    CSAHi CursorLine term=underline cterm=NONE ctermbg=241 ctermfg=fg gui=NONE guibg=#666666 guifg=fg
    CSAHi vimSynPatMod term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyHeredocStart term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimSynMatchRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi VimSynMtchCchar term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi ColorColumn term=reverse cterm=NONE ctermbg=59 ctermfg=fg gui=NONE guibg=#394658 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=187 ctermfg=17 gui=NONE guibg=#cad5c0 guifg=#05293d
    CSAHi lCursor term=NONE cterm=NONE ctermbg=103 ctermfg=16 gui=NONE guibg=#8b9aaa guifg=#1a202a
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=30 ctermfg=fg gui=NONE guibg=#008b8b guifg=fg
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=16 ctermfg=65 gui=NONE guibg=#1a202a guifg=#369960
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=74 gui=NONE guibg=bg guifg=#70a0de
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=73 gui=NONE guibg=bg guifg=#50a0b0
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=139 gui=NONE guibg=bg guifg=#a090b0
    CSAHi rubyMethodBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAugroup term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAugroupError term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimSyncLines term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncMatch term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=NONE ctermbg=bg ctermfg=181 gui=NONE guibg=bg guifg=#cac0c0
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=145 gui=NONE guibg=bg guifg=#c0a0b0
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=73 gui=NONE guibg=bg guifg=#6ac0ba
    CSAHi vimSyncRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=241 gui=NONE guibg=bg guifg=#666666
    CSAHi Error term=reverse cterm=NONE ctermbg=203 ctermfg=231 gui=NONE guibg=#f06070 guifg=#ffffff
    CSAHi Todo term=NONE cterm=NONE ctermbg=226 ctermfg=202 gui=NONE guibg=#eeee00 guifg=#ff4500
    CSAHi Number term=NONE cterm=NONE ctermbg=bg ctermfg=38 gui=NONE guibg=bg guifg=#1da5da
    CSAHi vimMenuMap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyDoBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyCurlyBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyArrayDelimiter term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimHiKeyList term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiBang term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Function term=NONE cterm=NONE ctermbg=16 ctermfg=139 gui=NONE guibg=#1a202a guifg=#a090a0
    CSAHi Conditional term=NONE cterm=NONE ctermbg=16 ctermfg=139 gui=NONE guibg=#1a202a guifg=#c08ac0
    CSAHi Repeat term=NONE cterm=NONE ctermbg=16 ctermfg=139 gui=NONE guibg=#1a202a guifg=#c07ac0
    CSAHi vimHiCtermColor term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Keyword term=NONE cterm=bold ctermbg=16 ctermfg=250 gui=bold guibg=#1a202a guifg=#bebebe
    CSAHi Exception term=NONE cterm=NONE ctermbg=16 ctermfg=145 gui=NONE guibg=#1a202a guifg=#aaa4a0
    CSAHi rubyOptionalDoLine term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyRepeatExpression term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimEscapeBrace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSetEqual term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSubstRep term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSubstRange term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi ExtraWhitespace term=NONE cterm=NONE ctermbg=22 ctermfg=fg gui=NONE guibg=#006400 guifg=fg
    CSAHi vimGroupName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiFontname term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiGuiFontname term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSynKeyRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimPatRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlFormat term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Operator term=NONE cterm=NONE ctermbg=16 ctermfg=137 gui=NONE guibg=#1a202a guifg=#aa9a45
    CSAHi vimHiTermcap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimCommentTitleLeader term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimGlobal term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi TabWhitespace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi perlSyncPOD term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimPerlRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=17 ctermfg=23 gui=NONE guibg=#22253d guifg=#223355
    CSAHi vimSyncLinebreak term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncLinecont term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Underlined term=underline cterm=NONE ctermbg=bg ctermfg=66 gui=NONE guibg=bg guifg=#5b759a
    CSAHi perlGenericBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimExtCmd term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimFilter term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSet term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=59 ctermfg=250 gui=NONE guibg=#394658 guifg=#bebebe
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=59 ctermfg=250 gui=NONE guibg=#394658 guifg=#bebebe
    CSAHi vimMenuRhs term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=65 gui=NONE guibg=bg guifg=#6d806a
    CSAHi Visual term=reverse cterm=NONE ctermbg=81 ctermfg=16 gui=NONE guibg=#43d5ff guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=147 ctermfg=17 gui=bold,underline guibg=#a3a5ff guifg=#201a30
    CSAHi WarningMsg term=NONE cterm=NONE ctermbg=bg ctermfg=209 gui=NONE guibg=bg guifg=#fa8072
    CSAHi WildMenu term=NONE cterm=NONE ctermbg=226 ctermfg=16 gui=NONE guibg=#ffff00 guifg=#000000
    CSAHi Folded term=NONE cterm=NONE ctermbg=17 ctermfg=152 gui=NONE guibg=#222038 guifg=#bbddcc
    CSAHi rubyRegexpParens term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyRegexpBrackets term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAuSyntax term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimUserCmd term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
...
elseif has("gui_running") || &t_Co == 88
    ...
    CSAHi perlVarBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlVarBlock2 term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SpecialKey term=bold cterm=NONE ctermbg=bg ctermfg=42 gui=NONE guibg=bg guifg=#90dcb0
    CSAHi NonText term=bold cterm=bold ctermbg=80 ctermfg=80 gui=bold guibg=#1a202a guifg=#382920
    CSAHi Directory term=bold cterm=NONE ctermbg=bg ctermfg=58 gui=NONE guibg=bg guifg=#bbd0df
    CSAHi ErrorMsg term=NONE cterm=NONE ctermbg=64 ctermfg=79 gui=NONE guibg=#ff4545 guifg=#ffffff
    CSAHi IncSearch term=reverse cterm=NONE ctermbg=57 ctermfg=80 gui=reverse guibg=#3a4520 guifg=#babeaa
    CSAHi Search term=reverse cterm=NONE ctermbg=37 ctermfg=80 gui=NONE guibg=#808373 guifg=#3a4520
    ...
    CSAHi LineNr term=underline cterm=NONE ctermbg=16 ctermfg=38 gui=NONE guibg=#000000 guifg=#8095d5
    CSAHi vimClusterName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi SpellLocal term=underline cterm=undercurl ctermbg=bg ctermfg=fg gui=undercurl guibg=bg guifg=fg guisp=#00ffff
    CSAHi Pmenu term=NONE cterm=NONE ctermbg=21 ctermfg=42 gui=NONE guibg=#3a6595 guifg=#9aadd5
    CSAHi PmenuSel term=NONE cterm=NONE ctermbg=38 ctermfg=59 gui=NONE guibg=#4a85ba guifg=#b0d0f0
    ...
    CSAHi TabLine term=underline cterm=NONE ctermbg=81 ctermfg=37 gui=NONE guibg=#4d4d5f guifg=#5b7098
    CSAHi TabLineSel term=bold cterm=NONE ctermbg=37 ctermfg=38 gui=NONE guibg=#515a71 guifg=#50aae5
    CSAHi TabLineFill term=reverse cterm=NONE ctermbg=80 ctermfg=84 gui=NONE guibg=#2d2d3f guifg=#aaaaaa
    ...
    CSAHi vimSynMatchRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi VimSynMtchCchar term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi ColorColumn term=reverse cterm=NONE ctermbg=21 ctermfg=fg gui=NONE guibg=#394658 guifg=fg
    CSAHi Cursor term=NONE cterm=NONE ctermbg=58 ctermfg=16 gui=NONE guibg=#cad5c0 guifg=#05293d
    CSAHi lCursor term=NONE cterm=NONE ctermbg=37 ctermfg=80 gui=NONE guibg=#8b9aaa guifg=#1a202a
    CSAHi MatchParen term=reverse cterm=NONE ctermbg=21 ctermfg=fg gui=NONE guibg=#008b8b guifg=fg
    CSAHi vimSynRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Comment term=bold cterm=NONE ctermbg=80 ctermfg=21 gui=NONE guibg=#1a202a guifg=#369960
    CSAHi Constant term=underline cterm=NONE ctermbg=bg ctermfg=38 gui=NONE guibg=bg guifg=#70a0de
    CSAHi Special term=bold cterm=NONE ctermbg=bg ctermfg=38 gui=NONE guibg=bg guifg=#50a0b0
    CSAHi Identifier term=underline cterm=NONE ctermbg=bg ctermfg=38 gui=NONE guibg=bg guifg=#a090b0
    CSAHi rubyMethodBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAugroup term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAugroupError term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimSyncLines term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncMatch term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Statement term=bold cterm=NONE ctermbg=bg ctermfg=58 gui=NONE guibg=bg guifg=#cac0c0
    CSAHi PreProc term=underline cterm=NONE ctermbg=bg ctermfg=54 gui=NONE guibg=bg guifg=#c0a0b0
    CSAHi Type term=underline cterm=NONE ctermbg=bg ctermfg=42 gui=NONE guibg=bg guifg=#6ac0ba
    CSAHi vimSyncRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Ignore term=NONE cterm=NONE ctermbg=bg ctermfg=81 gui=NONE guibg=bg guifg=#666666
    CSAHi Error term=reverse cterm=NONE ctermbg=69 ctermfg=79 gui=NONE guibg=#f06070 guifg=#ffffff
    CSAHi Todo term=NONE cterm=NONE ctermbg=76 ctermfg=64 gui=NONE guibg=#eeee00 guifg=#ff4500
    CSAHi Number term=NONE cterm=NONE ctermbg=bg ctermfg=22 gui=NONE guibg=bg guifg=#1da5da
    CSAHi vimMenuMap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyDoBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyCurlyBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyArrayDelimiter term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimHiKeyList term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiBang term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Function term=NONE cterm=NONE ctermbg=80 ctermfg=37 gui=NONE guibg=#1a202a guifg=#a090a0
    CSAHi Conditional term=NONE cterm=NONE ctermbg=80 ctermfg=54 gui=NONE guibg=#1a202a guifg=#c08ac0
    CSAHi Repeat term=NONE cterm=NONE ctermbg=80 ctermfg=54 gui=NONE guibg=#1a202a guifg=#c07ac0
    CSAHi vimHiCtermColor term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Keyword term=NONE cterm=bold ctermbg=80 ctermfg=85 gui=bold guibg=#1a202a guifg=#bebebe
    CSAHi Exception term=NONE cterm=NONE ctermbg=80 ctermfg=84 gui=NONE guibg=#1a202a guifg=#aaa4a0
    CSAHi rubyOptionalDoLine term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyRepeatExpression term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimEscapeBrace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSetEqual term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSubstRep term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSubstRange term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi ExtraWhitespace term=NONE cterm=NONE ctermbg=20 ctermfg=fg gui=NONE guibg=#006400 guifg=fg
    CSAHi vimGroupName term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiFontname term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimHiGuiFontname term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSynKeyRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi vimPatRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi perlFormat term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Operator term=NONE cterm=NONE ctermbg=80 ctermfg=36 gui=NONE guibg=#1a202a guifg=#aa9a45
    CSAHi vimHiTermcap term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimCommentTitleLeader term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimGlobal term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi TabWhitespace term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi perlSyncPOD term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimPerlRegion term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi VertSplit term=reverse cterm=NONE ctermbg=80 ctermfg=17 gui=NONE guibg=#22253d guifg=#223355
    CSAHi vimSyncLinebreak term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSyncLinecont term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Underlined term=underline cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=#5b759a
    CSAHi perlGenericBlock term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimExtCmd term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimFilter term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimSet term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi StatusLine term=reverse,bold cterm=NONE ctermbg=21 ctermfg=85 gui=NONE guibg=#394658 guifg=#bebebe
    CSAHi StatusLineNC term=reverse cterm=NONE ctermbg=21 ctermfg=85 gui=NONE guibg=#394658 guifg=#bebebe
    CSAHi vimMenuRhs term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi Title term=bold cterm=NONE ctermbg=bg ctermfg=37 gui=NONE guibg=bg guifg=#6d806a
    CSAHi Visual term=reverse cterm=NONE ctermbg=27 ctermfg=16 gui=NONE guibg=#43d5ff guifg=#000000
    CSAHi VisualNOS term=bold,underline cterm=bold,underline ctermbg=39 ctermfg=80 gui=bold,underline guibg=#a3a5ff guifg=#201a30
    ...
    CSAHi Folded term=NONE cterm=NONE ctermbg=80 ctermfg=58 gui=NONE guibg=#222038 guifg=#bbddcc
    CSAHi rubyRegexpParens term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi rubyRegexpBrackets term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimAuSyntax term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimUserCmd term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    ...
    CSAHi perlVarMember term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi vimNormCmds term=NONE cterm=NONE ctermbg=bg ctermfg=fg gui=NONE guibg=bg guifg=fg
    CSAHi FoldColumn term=NONE cterm=NONE ctermbg=16 ctermfg=57 gui=NONE guibg=#000000 guifg=#dbcaa5
